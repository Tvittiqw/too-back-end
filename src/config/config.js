...
.keys({
  ...
  JWT_ACCESS_EXPIRATION_MINUTES: Joi.number().required().description('minutes after which access tokens expire'),
  JWT_REFRESH_EXPIRATION_DAYS: Joi.number().required().description('days after which refresh tokens expire'),
